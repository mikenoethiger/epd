...
var EpdsComponent = (function () {
    ...
    EpdsComponent.prototype.sync = function () {
        var _this = this;
        this.http.get('/epd').subscribe(function (data) {
            _this.epds = data;
        });
